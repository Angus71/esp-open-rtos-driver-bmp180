...
//
LOCAL void bmp180_meassure(const bmp180_command_t* command);
LOCAL bool bmp180_informUser_Impl(const xQueueHandle* resultQueue, uint8_t cmd, bmp180_temp_t temperatue, bmp180_press_t pressure);
...
// I2C Driver Task
LOCAL void bmp180_driver_task(void *pvParameters)
{
...
LOCAL bool bmp180_create_communication_queues()
{
